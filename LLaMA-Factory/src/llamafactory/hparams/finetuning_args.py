...
class RLHFArguments:
    ...
    pref_loss: Literal["sigmoid", "hinge", "ipo", "kto_pair", "orpo", "simpo", "papo"] = field(
        default="sigmoid",
        metadata={"help": "The type of DPO loss to use. `papo` applies normalized per-example PAPO weights."},
    )
...
class FinetuningArguments(
    ...
    def __post_init__(self):
        ...
        if self.stage == "dpo" and self.pref_loss not in ["sigmoid", "papo"] and self.dpo_label_smoothing > 1e-6:
